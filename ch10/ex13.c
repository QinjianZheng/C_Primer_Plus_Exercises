...
char getChoice(void);
void setValue(int, int, double [ROWS][SIZE]);
double calMean(int, double[]);
double max2DArray(int, int, double [ROWS][SIZE]);
void print2DArray(int, int, double [ROWS][SIZE]);
...
void setValue(int row, int col, double array[ROWS][SIZE]) {
    double input;
    for(int i = 0; i < row; i++) {
        for(int j = 0; j < col; j++) {
            scanf("%lf", &input);
...
double max2DArray(int row, int col, double array[ROWS][SIZE]) {
...
void print2DArray(int row, int col, double array[ROWS][SIZE])  {
    for(int i = 0; i < row; i++) {
        for(int j = 0; j < col; j++) {
